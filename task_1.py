...
class CaesarCipher(tk.Frame):
    ...
    def render_widgets(self):
        ...
        self.title.grid(row=0, column=0, sticky=tk.EW, pady=35)
        ...
        self.buttons_container.grid(column=0, row=3, sticky=tk.NSEW, pady=100)

        self.buttons_encrypt = tk.Button(
        ...
        self.buttons_encrypt.grid(column=0, row=0, ipadx=5, ipady=5)

        self.buttons_decrypt = tk.Button(
            self.buttons_container,
            bg=self.colour2,
            fg=self.colour1,
            activebackground=self.colour3,
        ...
        self.buttons_decrypt.grid(column=2, row=0, ipadx=5, ipady=5)
    ...
    def key_entry_validation(self, value):
        if value == '':
            self.buttons_decrypt['state'] = tk.DISABLED
            self.buttons_encrypt['state'] = tk.DISABLED
            return True
        ...
        if value <= 0 or value >= self.num_letters:
            return False
        self.buttons_decrypt['state'] = tk.NORMAL
        self.buttons_encrypt['state'] = tk.NORMAL
